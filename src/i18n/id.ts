export const id = {
  ...
  dashboard: {
    ...
    revenueChartDescription: "Menampilkan pendapatan harian 7 hari terakhir",
  ...
  ppob: {
    ...
    notConfigured: "PPOB belum dikonfigurasi",
    configureInSettings: "Atur kredensial Mitra di Pengaturan → PPOB",
    // Settings
    settingsTitle: "Pengaturan PPOB",
    enabled: "Aktifkan PPOB",
    enabledDesc: "Aktifkan fitur PPOB Mitra Indogrosir",
    ...
    settingsSaved: "Pengaturan PPOB berhasil disimpan",
