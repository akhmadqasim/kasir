export const id = {
  ...
  settings: {
    ...
    sessionTimeoutDesc: "Menit tanpa aktivitas sebelum kasir harus login lagi (720 = 12 jam)",
    changePin: "Ganti PIN",
  ...
  whatsapp: {
    ...
    connectedNumber: "Nomor tertaut",
    scanInstruction: "Buka WhatsApp di HP → Perangkat Tertaut → Tautkan perangkat",
    disconnect: "Putuskan",
    disconnectConfirmTitle: "Putuskan WhatsApp?",
    disconnectConfirmBody:
      "Tautan ke WhatsApp akan diputus. Untuk memakainya lagi, pindai ulang kode QR.",
    disconnectConfirm: "Ya, Putuskan",
    captionTemplate: "Teks Pengantar Struk",
    captionTemplateDesc:
      "Dikirim sebagai keterangan gambar struk. Gunakan {store} untuk menyisipkan nama toko.",
    captionTemplatePlaceholder: "Terima kasih sudah belanja di {store}. Berikut struk Anda.",
    settingsSaved: "Pengaturan WhatsApp berhasil disimpan",
    enabledSuccess: "WhatsApp diaktifkan",
    disabledSuccess: "WhatsApp dinonaktifkan",
    disconnectedSuccess: "WhatsApp diputuskan",
    sendReceipt: "Kirim WhatsApp",
    sendDialogTitle: "Kirim Struk via WhatsApp",
    phoneNumber: "Nomor WhatsApp",
    phoneNumberPlaceholder: "0812...",
    phoneNumberRequired: "Nomor WhatsApp wajib diisi",
    send: "Kirim",
    sendSuccess: "Struk berhasil dikirim ke WhatsApp",
    sendFailed: "Gagal mengirim struk",
    lastSentTo: (phone: string) => `Terkirim ke ${phone}`,
  },
  users: {
